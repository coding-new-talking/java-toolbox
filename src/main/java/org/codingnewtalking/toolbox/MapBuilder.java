...
public class MapBuilder {
	...
	public MapBuilder kv(String name, Object value) {
		curr.addChild(new KeyValue(curr, name, value));
		return this;
	}
	
	public MapBuilder ko(String name) {
	...
	public MapBuilder ka(String name) {
	...
	public MapBuilder iv(Object value) {
		curr.addChild(new ItemValue(curr, value));
		return this;
	}
	
	public MapBuilder io() {
